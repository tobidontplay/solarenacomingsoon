    ...
    extend: {
      ...
      colors: {
        ...
        neon: {
          ...
          amber: "hsl(var(--neon-amber) / <alpha-value>)",
        },
        chart: {
      ...
      boxShadow: {
        ...
        'glow-sm': '0 0 5px rgba(168, 85, 247, 0.3)',
        'glow-md': '0 0 15px rgba(168, 85, 247, 0.4)',
        'glow-lg': '0 0 25px rgba(168, 85, 247, 0.5)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      backgroundImage: {
        ...
        'holographic': 'linear-gradient(135deg, #a855f7 0%, #06b6d4 50%, #ec4899 100%)',
      },
    },
  },
